...
def brandSelArch():
    while True:
        print(RED("WARNING: Choose your correct brand of your graphics card"))
        print(GREEN("\n[1] NVIDIA\n[2] AMD\n [3] INTEL\n[4] Back\n"))
        ...
        if brArchnd == 1:
            print(RED('''
				...
				'''))
            os.system(
                "sudo pacman -S nvidia nvidia-utils lib32-nvidia-utils nvidia-settings vulkan-icd-loader lib32-vulkan-icd-loader --needed")
        elif brArchnd == 2:
            print(RED('''
            ...
            if op == 'Y' or op == 'y':
                os.system(
                    "sudo pacman -S lib32-mesa vulkan-radeon lib32-vulkan-radeon vulkan-icd-loader lib32-vulkan-icd-loader --needed")
            elif op == 'N' or op == 'n':
                break
            else:
                print("Wrong option")
            ...
            if op == 'Y' or op == 'y':
                os.system(
                    "sudo pacman -S lib32-mesa vulkan-intel lib32-vulkan-intel vulkan-icd-loader lib32-vulkan-icd-loader --needed")
            elif op == 'N' or op == 'n':
                break
            else:
                print("Wrong option")
