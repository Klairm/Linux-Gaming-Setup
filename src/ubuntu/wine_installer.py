...
class WineInstaller:
    ...
    def install(self):
        ...
        self.apt.add_repository("'deb https://dl.winehq.org/wine-builds/ubuntu/ {} main'".format(codename))
        ...
        if os.WEXITSTATUS(os.system("sudo apt-get install --install-recommends wine-stable")) > 0:
            ...
            self.apt.install(["winehq-stable", "wine-stable", "wine-stable-i386", "wine-stable-amd64"], recommends=True)
